...
// import { billingExpenseService } from '../invoice.service';
...
import { BillingExpense, InvoiceDetails, InvoiceDetailsList } from '../invoices/invoice.model';
...
import { BillingExpenseComponent } from './billing-expense/billing-expense.component';

@Component({
  selector: 'app-billing-expenses',
  templateUrl: './billing-expenses.component.html',
  styleUrls: ['./billing-expenses.component.css'],
})
export class BillingExpensesComponent implements OnInit {
  isLoadingSubmit: boolean = false;

  constructor(
    public utilSvc: UtilityService,
    public service: BillingExpenseService,
    public billingExpenseService: BillingExpenseService,
...
*/
  ...
  resetForm() {
    ...
    this.service.formData.patchValue({
      billNO: this.billNoParam,
      dtDate: new Date(),
      // Total:this.billingExpenseService.balance.toFixed(2),
    });
  ...
  onClose() {
    ...
    this.service.clearFields();
    this.billingExpenseService.flgEdit = false;
    this.billingExpenseService.enableFields(false);
    if (this.billingExpenseService.formData)
      this.billingExpenseService.formData.reset();
    this.billingExpenseService.clearFields();
    this.utilSvc.setButtons(true);
    // this.billingExpenseService.reLoadData();
    this.dialogRef.close();

    // this.billingExpenseService.updateTotal(this.billNoParam);
    // this.service.flgEdit = false;
    // this.service.enableFields(false);
    // this.utilSvc.setButtons(true);
