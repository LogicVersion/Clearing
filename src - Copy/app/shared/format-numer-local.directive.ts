...
@Directive({
  selector: '[FormatNumerLocal]',
  providers: [
    {
      provide: MAT_INPUT_VALUE_ACCESSOR,
      useExisting: FormatNumerLocalDirective,
    },
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => FormatNumerLocalDirective),
      multi: true,
    },
  ],
})
export class FormatNumerLocalDirective
  implements ControlValueAccessor
{
  ...
  @Output('localizedNumericInputChange') valorChange =
